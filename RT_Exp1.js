...
var welcome_block = {
    ...
    stimulus: "<p> You succesfully finished the test trials. </p>" +
        "<p> You will now start the first trial of the experiment. Please again try to answer at least 80% correct. </p> " +
        "<p> </p>" +
        "<p> </p>" +
...
var debrief_block = {
    ...
    stimulus: function () {
        ...
        var accuracy2 = Math.round(correct_trials.count() / trials.count() * 100);
        var rt = Math.round(correct_trials.select('rt').mean());

        return "<p>You responded correctly on " + accuracy2 + "% of the trials.</p>" +
