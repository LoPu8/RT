...
var instructions1 = {
    ...
    stimulus: "<p>Auf den folgenden Seiten werden Sie jeweils drei Wörter sehen. " +
        ...
        "Wenn das <strong>rechte</strong> Wort (vom Text her) gleich ist wie Wort in der Mitte, drücken Sie bitte den Buchstaben <strong>j</strong>.</p>" +
      ...
      if(last_trial_correct){
        ...
        "<div >" +
          ...
          "<div style=';' class='sev'>" +
           ...
           "<p class='small', style = 'color:blue'><strong>Gelb</strong></p></div>" +
          "</div>" +
     "<p style = 'margin-top: 50px'> In diesem Beispiel ist das rechte Wort gleich im Vergleich zu dem in der Mitte. Daher <strong> drücken Sie bitte j auf der Tastatur.</strong> </p>" +
        "<p style = 'margin-top: 100px'>Drücken Sie eine beliebige Taste, um fortzufahren.</p>" +
        "</div>"  
...
var debrief_block = {
    ...
    stimulus: function () {
        ...
        return "<p>Sie haben " + accuracy_Test1 + "% der Aufgaben richtig beantwortet.</p>" +
            "<p style = 'margin-top: 100px'>Drücken Sie eine beliebige Taste, um fortzufahren!</p>";
